...
def tablaReporte(registros,  numTurno, fechaInicioTurno, fechaFinTurno, stateExcel, statePDF):
            ...
            <article class="portlet-title">
              ...
              <article class="actions">
                <a href=" """+linkExcel+""" " class="btn blue-sunglo hidden" id="descargarTurnoExcel"> Descargar Excel </a>
                    <a href="/reporte-turno/?turno="""+numTurno+"""&fechaInicio="""+fechaInicioTurno+"""&fechaFin="""+fechaFinTurno+"""&reporte=excel&excel="""+stateExcel+"""&pdf="""+statePDF+""" "  class="btn btn-default" id="generarTurnoExcel" onclick="$('#paginaCargando').modal('show');">Generar Excel</a>
    ...
    codeOpertations = """
                          <a href=" """+linkExcel+""" " class="btn blue-sunglo hidden" id="descargarTurnoExcel"> Descargar Excel </a>
                           <a href="/reporte-turno/?turno="""+numTurno+"""&fechaInicio="""+fechaInicioTurno+"""&fechaFin="""+fechaFinTurno+"""&reporte=excel&excel="""+stateExcel+"""&pdf="""+statePDF+""" "  class="btn btn-default" id="generarTurnoExcel" onclick="$('#paginaCargando').modal('show'), alert('3ntra');">Generar Excel</a>
