...
def tablaReporte(datos, startDate, endDate):
    ...
    codeOperations = """
                        <a href=" /reportes/?fecha1="""+startDate+"""&fecha2="""+endDate+"""&reporte=especifico" class="btn btn-default linkCabecera text-left" style="color:#666; align:left;"> Especifico </a>
                        <a href=" /reportes/?fecha1="""+startDate+"""&fecha2="""+endDate+"""&reporte=detallado" class="btn btn-default linkCabecera" id="detallado" style="color:#666;"> Generar Detallado </a>
                        ...
                        <a href=" /reportes/?fecha1="""+startDate+"""&fecha2="""+endDate+"""&reporte=generarGeneral" class="btn btn-default btn-default linkCabecera" id="generarExcel" style="color:#666;"><i class="fa fa-refresh"></i> Generar Excel </a>
